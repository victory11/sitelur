      ...
      >
        ...
        <div className="border-t border-white/10 p-4">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-[#1A6EB5] rounded-full flex items-center justify-center text-xs font-bold shrink-0">
              A
            </div>
            {!collapsed && (
              <div className="min-w-0">
                <p className="text-xs font-medium truncate">Administrator</p>
                <p className="text-[10px] text-gray-400 truncate">admin@rsud.go.id</p>
              </div>
            )}
          </div>
        </div>
